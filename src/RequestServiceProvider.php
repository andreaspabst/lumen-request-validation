...
namespace AndreasPabst\RequestValidation;
...
class RequestServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            \AndreasPabst\RequestValidation\Console\RequestMakeCommand::class
        ]);
    }
     ...
     *
     * @param  \AndreasPabst\RequestValidation\RequestAbstract  $form
